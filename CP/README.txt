...
1. To run run_one_instance you need to input solver, model name, filename.txt and instance. For example:  ./run_one_instance.sh gecode CP_A CP_MODEL_B_gecode.txt instance1
